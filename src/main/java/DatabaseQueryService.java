...
import behavior.db.model.*;
import behavior.db.service.*;
...
public class DatabaseQueryService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ClientDaoService clientDao = new ClientDaoServiceImpl();
        ...
        clientService.setName(3, "Оновлення клієнта");

        clientService.deleteById(10);

        List<Client> allClient = clientService.listAll();
